...
class ConfigurationServiceTest {
    ...
    void shouldLoadValidPrinterConfiguration() throws ConfigurationException {
        ...
        assertThat(config.getName()).isEqualTo("TM-T20III");
        assertThat(config.getIpAddress()).isEqualTo("10.0.0.150");
        assertThat(config.getPort()).isEqualTo(9100);
    ...
    void shouldLoadValidVFDConfiguration() throws ConfigurationException {
        ...
        // Then
        assertThat(config).isNotNull();
        assertThat(config.getDisplayType()).isEqualTo(EDisplayType.FV_2030B);
        assertThat(config.getPortName()).isEqualTo("COM3");
    ...
    void shouldLoadValidServerConfiguration() throws ConfigurationException {
        ...
        assertThat(config.getStatusCheckInterval()).isEqualTo(5000);
        assertThat(config.isMonitoringEnabled()).isTrue();
        assertThat(config.getThreadPoolSize()).isEqualTo(3);
    }
